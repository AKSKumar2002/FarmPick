const scriptURL = "https://script.google.com/macros/s/AKfycbzivlI8VlN_vg62Q4xO8IUQFtlWJrkA--oQXSmeNvU5yyVFOj3eA3JTt7xTuQektOszGg/exec";
  ...
  fetch(scriptURL, {
    ...
    .then(res => {
      if (res.status === "success") {
        ...
        setTimeout(() => window.location.href = "mm.html", 2000);
      } else {
